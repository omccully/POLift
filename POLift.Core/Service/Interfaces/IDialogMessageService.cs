...
namespace POLift.Core.Service
{
    public interface IDialogMessageService
    {
        ...
        void DisplayConfirmation(string message, Action action_if_yes, 
            Action action_if_no = null);

        void DisplayConfirmationNeverShowAgain(string message, 
            string preference_key, Action action_if_yes,
            Action action_if_no = null);

        void DisplayConfirmationYesNotNowNever(
            string message, string ask_for_key,
            Action action_if_yes);

        void DisplayTemporaryError(string message);
